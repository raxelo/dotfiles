...
fish_add_path /Users/lucas/.volta/bin


# function to switch between projects with tmux.
#
# uses `ghq list` to list all projects, and fzf to select.
function ghq_tmx
